...
for file in star_path.rglob('*'):
    ...
    and '__' not in str(file) \
    and 'version.json' not in str(file) \
    and '.gitignore' not in str(file) \
    and 'LICENSE' not in str(file) \
    and 'star_list.json' not in str(file) \
    and 'picture' not in str(file) \
    and 'map' not in str(file) \
    and 'env' not in str(file) \
    and 'logs' not in str(file) \
    and 'Auto_Star_Rail_backup' not in str(file) \
